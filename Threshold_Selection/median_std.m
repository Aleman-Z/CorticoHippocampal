function [sig1,sig2,ripple2,carajo,veamos,CHTM,RipFreq2,timeasleep]=median_std
%{
...
%%
aver=cell2mat(Mono17);
[newvector, ~]=outlier(aver,5);
chtm=median(newvector)+3*std(newvector);
CHTM=chtm*(1/0.195);
...
% for k=1:rep-2
%k=level;
[S2x,E2x,M2x] =cellfun(@(equis1,equis2) findRipplesLisa(equis1, equis2.', CHTM, (CHTM)*(1/2), [] ), signal,ti,'UniformOutput',false);    
