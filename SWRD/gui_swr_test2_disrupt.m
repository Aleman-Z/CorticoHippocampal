...
%xo
[x,y,z,~,~,~,l,p,si_mixed,th]=hfo_specs(si,timeasleep,1,Rat,tr);
cd ..
...
[ripple,RipFreq,rip_duration,Mx_hpc,timeasleep,sig_hpc,Ex_hpc,Sx_hpc,...
  ...
  V,Mono]=gui_findripples_swrd(HPC,states,{'HPC'},tr,multiplets,fn);
...
writetable(TT,strcat('SWRD_slower_faster_cohfos_',num2str(tr(1)),'_',num2str(tr(2)),'.xls'),'Sheet',1,'Range','A1:Z50')
...
writetable(TT,strcat('SWRD_slower_faster_singles_',num2str(tr(1)),'_',num2str(tr(2)),'.xls'),'Sheet',1,'Range','A1:Z50')
