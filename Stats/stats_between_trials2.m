function [stats]=stats_between_trials2(freq1,freq2,label1,w)
cfg = [];
cfg.latency          = [-0.5 .5];  % time of interest (exclude baseline: it doesn't make sense to compute statistics on a region we expect to be zero)
