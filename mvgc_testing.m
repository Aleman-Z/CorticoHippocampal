...
ntrials   = length(p);     % number of trials
nobs      = length(p{1});   % number of observations per trial
...
% For good measure we calculate Seth's causal density (cdd) measure - the mean
