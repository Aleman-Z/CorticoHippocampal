...
if col~=row
    max1=[max(squeeze(granger1.grangerspctrm(row,col,:))) ...
        max(squeeze(granger2.grangerspctrm(row,col,:))) ...
        max(squeeze(granger3.grangerspctrm(row,col,:))) ...
        max(squeeze(granger4.grangerspctrm(row,col,:))) ...
        max(squeeze(granger5.grangerspctrm(row,col,:))) ...
        max(squeeze(granger6.grangerspctrm(row,col,:))) 
          
    ];
   max1=max(max1);
   
   %Opposite direction. 
    max2=[max(squeeze(granger1.grangerspctrm(col,row,:))) ...
        max(squeeze(granger2.grangerspctrm(col,row,:))) ...
        max(squeeze(granger3.grangerspctrm(col,row,:))) ...
        max(squeeze(granger4.grangerspctrm(col,row,:))) ...
        max(squeeze(granger5.grangerspctrm(col,row,:))) ...
        max(squeeze(granger6.grangerspctrm(col,row,:))) 
