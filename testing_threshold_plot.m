...
h=legend('Baseline 1','Baseline 1 (fit)','Baseline 2','Baseline 2 (fit)',labelconditions{1},strcat(labelconditions{1},'{ }','(fit)'),labelconditions{2},strcat(labelconditions{2},'{ }','(fit)'),labelconditions{3},strcat(labelconditions{3},'{ }','(fit)'),labelconditions{4},strcat(labelconditions{4},'{ }','(fit)'),labelconditions{5},strcat(labelconditions{5},'{ }','(fit)'))
...
% ylim([-0.5 3])
% error('stop')
string=strcat('Ripples_vs_threshold','.png');
...
string=strcat('Ripples_vs_threshold','.fig');
