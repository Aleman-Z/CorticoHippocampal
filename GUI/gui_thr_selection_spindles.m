...
%     [Sx_pfc,Ex_pfc,Mx_pfc] =cellfun(@(equis1,equis2) findSpindlesLisa(equis1, equis2, D2, (D2)*(1/2), fn), signal3_pfc,ti,'UniformOutput',false);    
    [Sx_pfc,Ex_pfc,Mx_pfc] =cellfun(@(equis1,equis2,equis3) findSpindlesWithPeaks(equis1, equis2,equis3, D2, (D2)*(1/2), fn,minpeak), signal3_pfc,signal2_pfc,ti,'UniformOutput',false);    
...
yticklabels({'HPC',xx{1},'HPC (9-20Hz)',[xx{1} ' (9-20Hz)']})
