function [ripple2,RipFreq2,rip_duration,Mx,timeasleep,sig,Ex,Sx,ripple_multiplets,RipFreq_multiplets,rip_duration_multiplets,sig_multiplets,M_multiplets,Mr]=gui_findripples_random(CORTEX,states,xx,tr,multiplets,fn)
...
%     random_x = ti{1}(randperm(size(ti{1}, 1)))
    %xo
    if strcmp(xx{1},'HPC')
