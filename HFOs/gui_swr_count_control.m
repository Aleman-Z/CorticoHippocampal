...
%% NORMALIZED
%aver=random_cohfos_count_g2./cohfos_count_g2.';
set(0,'defaultAxesFontName', 'Arial')
set(0,'defaultTextFontName', 'Arial')

close all
n=4;
aver=[aver_g2_26(n,:) aver_g2_27(n,:) aver_g2_24(n,:)];
...
%  histogram(vec,[-20.5:2:6.5],'FaceColor',[0 0 0])
%  xlim([-20 20])
...
%  histogram(vec,[-16.5:2:6.5],'FaceColor',[0 0 0])
%  xlim([-20 5])
...
printing(['plotnorm_fast_' labelconditions{n}])
 close all
%%    
  printing('control_24_simulated_slow_95lines')  
%% NEW NORMALIZATION (Z-SCORE-LIKE)
% 
...
histogram(vec_g1,'FaceColor',[0 0 0])
    ylabel('Frequency')
    xlabel('Count')
    Y1 = prctile(vec_g1,5)
    Y2 = prctile(vec_g1,95)
%     Y3 = prctile(vec_g1,2.5)
%     Y4 = prctile(vec_g1,97.5)
...
%     xline(Y4, '--k','LineWidth',2)
    ...
    xline(mean([vec_g1_count_24 vec_g1_count_26 vec_g1_count_27]), '-r','LineWidth',2)
    
y1=prctile([vec_g1_count_24 vec_g1_count_26 vec_g1_count_27],5)
y2=prctile([vec_g1_count_24 vec_g1_count_26 vec_g1_count_27],95)

xline(y1, '--r','LineWidth',2)
xline(y2, '--r','LineWidth',2)

%%
vec_g2=[vec_g2_24; vec_g2_26; vec_g2_27];
histogram(vec_g2,'FaceColor',[0 0 0])
    ylabel('Frequency')
    xlabel('Count')
    Y1 = prctile(vec_g2,5)
    Y2 = prctile(vec_g2,95)
%     Y3 = prctile(vec_g2,2.5)
%     Y4 = prctile(vec_g2,97.5)
...
%     xline(Y4, '--k','LineWidth',2)
    ...
    xline(mean([vec_g2_count_24 vec_g2_count_26 vec_g2_count_27]), '-r','LineWidth',2)

y1=prctile([vec_g2_count_24 vec_g2_count_26 vec_g2_count_27],5)
y2=prctile([vec_g2_count_24 vec_g2_count_26 vec_g2_count_27],95)
