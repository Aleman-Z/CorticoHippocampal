...
def pack(folderpath, source='100', **kwargs):
    ...
    bar = ProgressBar(len(data[data.keys()[0]][
                              'data']))  # progressbar.ProgressBar(maxval=1, widgets=[progressbar.Bar('=', '[', ']'), ' ', progressbar.Percentage()])
...
print('Hola')
# Channel 11 renamed as channel 9
# dat = loadContinuous('intentalo.continuous')
dat = loadContinuous('100_CH11.continuous')
print(dat)
first = list(dat)[0:4]
# print(first)
...
# dat = loadContinuous('intentalo.continuous')
dat = loadContinuous('100_CH22.continuous')
print(dat)
# print(first)
data = dat['data']
del dat
