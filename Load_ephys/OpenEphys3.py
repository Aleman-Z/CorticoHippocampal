...
dat = loadContinuous('100_CH9.continuous')
print(dat)
first= list(dat)[0:4]
# print(first)
...
y9=np.concatenate((Y1,Y2));

import scipy.io as sio
sio.savemat('y9.mat',{'y9':y9})

#Channel 6
print('Hola')

#dat = loadContinuous('intentalo.continuous')
dat = loadContinuous('100_CH6.continuous')
print(dat)
# print(first)
timestamps=dat['timestamps']
data=dat['data']
...
y6=np.concatenate((Y1,Y2));

import scipy.io as sio
sio.savemat('y6.mat',{'y6':y6})

#Channel 12
print('Hola')

#dat = loadContinuous('intentalo.continuous')
dat = loadContinuous('100_CH12.continuous')
print(dat)
# print(first)
timestamps=dat['timestamps']
data=dat['data']
...
#dat = loadContinuous('intentalo.continuous')
dat = loadContinuous('100_CH17.continuous')
print(dat)
# print(first)
timestamps=dat['timestamps']
data=dat['data']
...
y17=np.concatenate((Y1,Y2));

import scipy.io as sio
sio.savemat('y17.mat',{'y17':y17})
...
veamos=data[0:10000] #Sample of whole data
t_veamos=timestamps[1:1000] #Gives linear counters
r_veamos=recordingNumber[1:1000] #Gives zeros
"""
...
fs=20000
x=np.arange(len(veamos))*(1/fs)

plt.plot(x,veamos,'r') # plotting by columns
