...
string=strcat('RippleDuration_Outliers_','Allconditions','_',Block{block_time+1},'_','.pdf');
figure_function(gcf,[],string,[]);
string=strcat('RippleDuration_Outliers_','Allconditions','_',Block{block_time+1},'_','.eps');
print(string,'-depsc')
