...
%[n, g1,g1_f,G,G_f,FB,FB1]=getval_granger(SP,SQ,labelconditions2,label1,s,w,fn, tf);
[n, g_tf1]=getval_granger(SP,SQ,labelconditions2,label1,s,w,fn, tf);
...
%-------------
w=3; %PAR
%[n2, g1,g1_f,G,G_f,FB,FB1]=getval_granger(FP,FQ,labelconditions2,label1,s,w,fn, tf);
[n2, g_tf2]=getval_granger(FP,FQ,labelconditions2,label1,s,w,fn, tf);
...
%s=2; %Slow singles
w=1;%HPC
%[n3,g1,g1_f,G,G_f,FB,FB1]=getval_granger(P,Q,labelconditions2,label1,s,w,fn, tf);
[n3, g_tf3]=getval_granger(P,Q,labelconditions2,label1,s,w,fn, tf);
